...
writeLines(menTablesV2$`2002`,'2002.txt')
...
# Write out a single file for offline use
writeLines(menTablesV2$'2005', con = '2005_men_results.txt')
writeLines(menTablesV2$'2009', con = '2009_men_results.txt')
